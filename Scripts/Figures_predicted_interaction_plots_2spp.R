  ...
  marg_coug_wtd_cattle <- marginal_occ_g(gs_cougwtd_graze2, elev = scaled_elev[,2], act = 0, 
                                       forest = 0, pub = 1, area = 0, spp1 = "cougar", 
                                       spp2 = "wtd", cov = scaled_elev[,1])
  marg_coug_moose_cattle <- marginal_occ_g(gs_cougmoose_graze0, elev = scaled_elev[,2], act = 0, 
                                         forest = 0, pub = 1, area = 0, spp1 = "cougar", 
  ...
  marg_wolf_elk_cattle <- marginal_occ_g(gs_wolfelk_hab0, elev = scaled_elev[,2], act = 0, 
                                       ...
                                       spp2 = "elk", cov = scaled_elev[,1])
  marg_wolf_wtd_cattle <- marginal_occ_g(gs_wolfwtd_graze0, elev = scaled_elev[,2], act = 0, 
                                       forest = 0, pub = 1, area = 0, spp1 = "wolf", 
                                       spp2 = "wtd", cov = scaled_elev[,1])
  marg_wolf_moose_cattle <- marginal_occ_g(gs_wolfmoose_graze0, elev = scaled_elev[,2], act = 0, 
                                         forest = 0, pub = 1, area = 0, spp1 = "wolf", 
                                         spp2 = "moose", cov = scaled_elev[,1])
  marg_bear_md_cattle <- marginal_occ_g(gs_bearmd_hab1, elev = scaled_elev[,2], act = 0, 
                                     forest = 0, pub = 1, area = 1, spp1 = "blackbear", 
                                     spp2 = "muledeer", cov = scaled_elev[,1])
  marg_bear_elk_cattle <- marginal_occ_g(gs_bearelk_hab1, elev = scaled_elev[,2], act = 0, 
                                       forest = 0, pub = 1, area = 0, spp1 = "blackbear", 
                                       spp2 = "elk", cov = scaled_elev[,1])
  marg_bear_wtd_cattle <- marginal_occ_g(gs_bearwtd_graze0, elev = scaled_elev[,2], act = 0, 
                                      forest = 0, pub = 1, area = 0, spp1 = "blackbear", 
                                      spp2 = "wtd", cov = scaled_elev[,1])
  marg_bear_moose_cattle <- marginal_occ_g(gs_bearmoose_graze0, elev = scaled_elev[,2], act = 0, 
                                         forest = 0, pub = 1, area = 0, spp1 = "blackbear", 
                                         spp2 = "moose", cov = scaled_elev[,1])
  marg_bob_md_cattle <- marginal_occ_g(gs_bobmd_graze0, elev = scaled_elev[,2], act = 0, 
                                      forest = 0, pub = 1, area = 1, spp1 = "bobcat", 
                                      spp2 = "mule_deer", cov = scaled_elev[,1])
  marg_bob_wtd_cattle <- marginal_occ_g(gs_bobwtd_graze2, elev = scaled_elev[,2], act = 0, 
  ...
  marg_coy_md_cattle <- marginal_occ_g(gs_coymd_graze2, elev = scaled_elev[,2], act = 0, 
                                     ...
                                     spp2 = "mule_deer", cov = scaled_elev[,1])
  marg_coy_wtd_cattle <- marginal_occ_g(gs_coywtd_graze2, elev = scaled_elev[,2], act = 0, 
  ...
  sppX_coug_moose_cattle <- spp_interactions_g(gs_cougmoose_graze0, elev = 0, act = scaled_graze[,2], 
                                             forest = 0, pub = 1, area = 1, spp1 = "cougar", 
  ...
  sppX_wolf_elk_cattle <- spp_interactions_g(gs_wolfelk_hab0, elev = 0, act = scaled_graze[,2], 
                                             forest = 0, pub = 1, area = 0, spp1 = "wolf", 
                                             spp2 = "elk", cov = scaled_graze[,1])
  sppX_wolf_wtd_cattle <- spp_interactions_g(gs_wolfwtd_graze0, elev = 0, act = scaled_graze[,2], 
                                             forest = 0, pub = 1, area = 1, spp1 = "wolf", 
                                             spp2 = "wtd", cov = scaled_graze[,1])
  sppX_wolf_moose_cattle <- spp_interactions_g(gs_wolfmoose_graze0, elev = 0, act = scaled_graze[,2], 
                                               forest = 0, pub = 1, area = 1, spp1 = "wolf", 
                                               spp2 = "moose", cov = scaled_graze[,1])
  sppX_bear_md_cattle <- spp_interactions_g(gs_bearmd_hab1, elev = 0, act = scaled_graze[,2], 
                                            forest = 0, pub = 1, area = 1, spp1 = "blackbear", 
                                            spp2 = "muledeer", cov = scaled_graze[,1])
  sppX_bear_elk_cattle <- spp_interactions_g(gs_bearelk_hab1, elev = 0, act = scaled_graze[,2], 
                                             forest = 0, pub = 1, area = 0, spp1 = "blackbear", 
                                             spp2 = "elk", cov = scaled_graze[,1])
  sppX_bear_wtd_cattle <- spp_interactions_g(gs_bearwtd_graze0, elev = 0, act = scaled_graze[,2], 
                                             forest = 0, pub = 1, area = 1, spp1 = "blackbear", 
                                             spp2 = "wtd", cov = scaled_graze[,1])
  sppX_bear_moose_cattle <- spp_interactions_g(gs_bearmoose_graze0, elev = 0, act = scaled_graze[,2], 
                                               forest = 0, pub = 1, area = 1, spp1 = "blackbear", 
                                               spp2 = "moose", cov = scaled_graze[,1])
  sppX_bob_md_cattle <- spp_interactions_g(gs_bobmd_graze0, elev = 0, act = scaled_graze[,2], 
                                           forest = 0, pub = 1, area = 1, spp1 = "bobcat", 
