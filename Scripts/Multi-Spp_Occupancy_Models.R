  ...
  occFormulas_hab1 <- c("~Study_Area + Elev + I(Elev^2) + PercForest", 
                        ...
                        "~1", "~1", "~1",
                        "~0")
  occFormulas_hab2 <- c("~Study_Area + Elev + I(Elev^2) + PercForest", 
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~PercForest",
                        "~PercForest",
                        "~PercForest",
                        "~0")
  occFormulas_hab3 <- c("~Study_Area + Elev + I(Elev^2) + PercForest", 
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~0")
  occFormulas_hab4 <- c("~Study_Area + Elev + I(Elev^2) + PercForest", 
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~Study_Area + Elev + I(Elev^2) + PercForest",
                        "~PercForest",
                        "~PercForest",
  ...
  (coug.md.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, coug_md_cattle_grazing_UMF, silent = TRUE))
  (coug.md.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, coug_md_cattle_grazing_UMF, silent = TRUE))
  (coug.md.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, coug_md_cattle_grazing_UMF, silent = TRUE)) # FAIL
  coug.md.cow_fl <- fitList(coug.md.cow_null0, coug.md.cow_null1, coug.md.cow_null2, coug.md.cow_hab0, coug.md.cow_hab1, coug.md.cow_hab2, coug.md.cow_hab3)
  #' Model selection
  ...
  (coug.elk.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, coug_elk_cattle_grazing_UMF, silent = TRUE))
  (coug.elk.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, coug_elk_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (coug.elk.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, coug_elk_cattle_grazing_UMF, silent = TRUE)) 
  coug.elk.cow_fl <- fitList(coug.elk.cow_null0, coug.elk.cow_null1, coug.elk.cow_null2, coug.elk.cow_hab0, coug.elk.cow_hab1, coug.elk.cow_hab2, coug.elk.cow_hab4)
  #' Model selection
  modSel(coug.elk.cow_fl)
  summary(coug.elk.cow_hab2)
  summary(coug.elk.cow_hab4)
  ...
  (coug.wtd.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, coug_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (coug.wtd.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, coug_wtd_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (coug.wtd.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, coug_wtd_cattle_grazing_UMF, silent = TRUE)) 
  coug.wtd.cow_fl <- fitList(coug.wtd.cow_null0, coug.wtd.cow_null1, coug.wtd.cow_null2, coug.wtd.cow_hab0, coug.wtd.cow_hab1, coug.wtd.cow_hab2, coug.wtd.cow_hab4)
  #' Model selection
  modSel(coug.wtd.cow_fl)
  summary(coug.wtd.cow_hab2)
  ...
  (coug.moose.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, coug_moose_cattle_grazing_UMF, silent = TRUE)) 
  (coug.moose.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, coug_moose_cattle_grazing_UMF, silent = TRUE)) 
  (coug.moose.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, coug_moose_cattle_grazing_UMF, silent = TRUE)) 
  coug.moose.cow_fl <- fitList(coug.moose.cow_null0, coug.moose.cow_null1, coug.moose.cow_null2, coug.moose.cow_hab0, coug.moose.cow_hab1, coug.moose.cow_hab2, coug.moose.cow_hab3, coug.moose.cow_hab4)
  #' Model selection
  modSel(coug.moose.cow_fl)
  summary(coug.moose.cow_hab0)
  summary(coug.moose.cow_hab2)
  ...
  (wolf.md.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, wolf_md_cattle_grazing_UMF, silent = TRUE))
  (wolf.md.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, wolf_md_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (wolf.md.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, wolf_md_cattle_grazing_UMF, silent = TRUE)) 
  wolf.md.cow_fl <- fitList(wolf.md.cow_null0, wolf.md.cow_null1, wolf.md.cow_null2, wolf.md.cow_hab0, wolf.md.cow_hab1, wolf.md.cow_hab2, wolf.md.cow_hab4)
  #' Model selection
  modSel(wolf.md.cow_fl)
  summary(wolf.md.cow_hab0)
  summary(wolf.md.cow_hab1)
  ...
  (wolf.elk.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, wolf_elk_cattle_grazing_UMF, silent = TRUE))
  (wolf.elk.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, wolf_elk_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (wolf.elk.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, wolf_elk_cattle_grazing_UMF, silent = TRUE)) # FAIL 
  wolf.elk.cow_fl <- fitList(wolf.elk.cow_null0, wolf.elk.cow_null1, wolf.elk.cow_hab0, wolf.elk.cow_hab1, wolf.elk.cow_hab2)
  #' Model selection
  modSel(wolf.elk.cow_fl)
  summary(wolf.elk.cow_hab2)
  ...
  (wolf.wtd.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, wolf_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (wolf.wtd.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, wolf_wtd_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (wolf.wtd.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, wolf_wtd_cattle_grazing_UMF, silent = TRUE)) # FAIL
  wolf.wtd.cow_fl <- fitList(wolf.wtd.cow_null0, wolf.wtd.cow_null1, wolf.wtd.cow_null2, wolf.wtd.cow_hab0, wolf.wtd.cow_hab1, wolf.wtd.cow_hab2, wolf.wtd.cow_hab4)
  #' Model selection
  modSel(wolf.wtd.cow_fl)
  summary(wolf.wtd.cow_hab1)
  summary(wolf.wtd.cow_hab2)
  ...
  (wolf.moose.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, wolf_moose_cattle_grazing_UMF, silent = TRUE)) 
  (wolf.moose.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, wolf_moose_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (wolf.moose.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, wolf_moose_cattle_grazing_UMF, silent = TRUE))
  wolf.moose.cow_fl <- fitList(wolf.moose.cow_null0, wolf.moose.cow_null1, wolf.moose.cow_null2, wolf.moose.cow_hab0, wolf.moose.cow_hab1, wolf.moose.cow_hab2, wolf.moose.cow_hab4)
  #' Model selection
  ...
  (bear.md.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, bear_md_cattle_grazing_UMF, silent = TRUE))
  (bear.md.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, bear_md_cattle_grazing_UMF, silent = TRUE)) 
  (bear.md.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, bear_md_cattle_grazing_UMF, silent = TRUE)) 
  bear.md.cow_fl <- fitList(bear.md.cow_null0, bear.md.cow_null1, bear.md.cow_null2, bear.md.cow_hab0, bear.md.cow_hab1, bear.md.cow_hab2, bear.md.cow_hab3, bear.md.cow_hab4)
  #' Model selection
  modSel(bear.md.cow_fl)
  summary(bear.md.cow_hab1)
  summary(bear.md.cow_hab2)
  summary(bear.md.cow_hab0)
  summary(bear.md.cow_hab4)
  ...
  (bear.elk.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, bear_elk_cattle_grazing_UMF, silent = TRUE))
  (bear.elk.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, bear_elk_cattle_grazing_UMF, silent = TRUE)) # FAIL
  (bear.elk.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, bear_elk_cattle_grazing_UMF, silent = TRUE)) # FAIL
  bear.elk.cow_fl <- fitList(bear.elk.cow_null0, bear.elk.cow_null1, bear.elk.cow_null2, bear.elk.cow_hab0, bear.elk.cow_hab1, bear.elk.cow_hab2)
  #' Model selection
  modSel(bear.elk.cow_fl)
  summary(bear.elk.cow_hab2)
  ...
  (bear.wtd.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, bear_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (bear.wtd.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, bear_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (bear.wtd.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, bear_wtd_cattle_grazing_UMF, silent = TRUE)) 
  bear.wtd.cow_fl <- fitList(bear.wtd.cow_null0, bear.wtd.cow_null1, bear.wtd.cow_null2, bear.wtd.cow_hab0, bear.wtd.cow_hab1, bear.wtd.cow_hab2, bear.wtd.cow_hab3, bear.wtd.cow_hab4)
  #' Model selection
  modSel(bear.wtd.cow_fl)
  summary(bear.wtd.cow_hab2)
  summary(bear.wtd.cow_hab1)
  summary(bear.wtd.cow_hab4)
  ...
  (bear.moose.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, bear_moose_cattle_grazing_UMF, silent = TRUE)) 
  (bear.moose.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, bear_moose_cattle_grazing_UMF, silent = TRUE))
  (bear.moose.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, bear_moose_cattle_grazing_UMF, silent = TRUE)) # FAIL
  bear.moose.cow_fl <- fitList(bear.moose.cow_null0, bear.moose.cow_null1, bear.moose.cow_null2, bear.moose.cow_hab0, bear.moose.cow_hab1, bear.moose.cow_hab2, bear.moose.cow_hab3)
  #' Model selection
  modSel(bear.moose.cow_fl)
  summary(bear.moose.cow_hab0)
  summary(bear.moose.cow_hab1)
  ...
  (coy.md.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, coy_md_cattle_grazing_UMF, silent = TRUE))
  (coy.md.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, coy_md_cattle_grazing_UMF, silent = TRUE)) 
  (coy.md.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, coy_md_cattle_grazing_UMF, silent = TRUE)) 
  coy.md.cow_fl <- fitList(coy.md.cow_null0, coy.md.cow_null1, coy.md.cow_null2, coy.md.cow_hab0, coy.md.cow_hab1, coy.md.cow_hab2, coy.md.cow_hab3, coy.md.cow_hab4)
  #' Model selection
  modSel(coy.md.cow_fl)
  summary(coy.md.cow_hab1)
  summary(coy.md.cow_hab2)
  summary(coy.md.cow_hab3)
  ...
  (coy.wtd.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, coy_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (coy.wtd.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, coy_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (coy.wtd.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, coy_wtd_cattle_grazing_UMF, silent = TRUE)) 
  coy.wtd.cow_fl <- fitList(coy.wtd.cow_null0, coy.wtd.cow_null1, coy.wtd.cow_null2, coy.wtd.cow_hab0, coy.wtd.cow_hab1, coy.wtd.cow_hab2, coy.wtd.cow_hab3, coy.wtd.cow_hab4)
  #' Model selection
  modSel(coy.wtd.cow_fl)
  summary(coy.wtd.cow_hab2)
  summary(coy.wtd.cow_hab4)
  ...
  (bob.md.cow_hab2 <- occuMulti(detFormulas_trail, occFormulas_hab2, bob_md_cattle_grazing_UMF, silent = TRUE))
  (bob.md.cow_hab3 <- occuMulti(detFormulas_trail, occFormulas_hab3, bob_md_cattle_grazing_UMF, silent = TRUE)) 
  (bob.md.cow_hab4 <- occuMulti(detFormulas_trail, occFormulas_hab4, bob_md_cattle_grazing_UMF, silent = TRUE)) 
  bob.md.cow_fl <- fitList(bob.md.cow_null0, bob.md.cow_null1, bob.md.cow_null2, bob.md.cow_hab0, bob.md.cow_hab1, bob.md.cow_hab2, bob.md.cow_hab3, bob.md.cow_hab4)
  #' Model selection
  modSel(bob.md.cow_fl)
  summary(bob.md.cow_hab1)
  summary(bob.md.cow_hab4)
  ...
  (bob.wtd.cow_hab2 <- occuMulti(detFormulas_graze, occFormulas_hab2, bob_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (bob.wtd.cow_hab3 <- occuMulti(detFormulas_graze, occFormulas_hab3, bob_wtd_cattle_grazing_UMF, silent = TRUE)) 
  (bob.wtd.cow_hab4 <- occuMulti(detFormulas_graze, occFormulas_hab4, bob_wtd_cattle_grazing_UMF, silent = TRUE)) 
  bob.wtd.cow_fl <- fitList(bob.wtd.cow_null0, bob.wtd.cow_null1, bob.wtd.cow_null2, bob.wtd.cow_hab0, bob.wtd.cow_hab1, bob.wtd.cow_hab2, bob.wtd.cow_hab3, bob.wtd.cow_hab4)
  #' Model selection
  modSel(bob.wtd.cow_fl)
  summary(bob.wtd.cow_hab3)
  ...
  occFormulas_habpub2 <- c("~Study_Area + Elev + I(Elev^2) + PercForest + Public",
                           ...
                           "~Public", "~1", "~1",
                           "~0")
  occFormulas_habpub3 <- c("~Study_Area + Elev + I(Elev^2) + PercForest + Public",
                           "~Study_Area + Elev + I(Elev^2) + PercForest + Public",
                           "~Study_Area + Elev + I(Elev^2) + PercForest + Public",
  ...
  (coug.md.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpubish3, coug_md_hunter_hunting_UMF, silent = TRUE)) 
  ...
  #' List of fitted models
  coug.md.hunt_fl <- fitList(coug.md.hunt_null0, coug.md.hunt_null1, coug.md.hunt_habpub0, coug.md.hunt_habpub1, coug.md.hunt_habpub2, coug.md.hunt_habpub3, coug.md.hunt_huntpub1, coug.md.hunt_huntpub2) 
  #' Model selection
  ...
  (coug.elk.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpubish3, coug_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  (coug.wtd.hunt_habpub2 <- occuMulti(detFormulas_pub, occFormulas_habpubish2, coug_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL
  (coug.wtd.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpubish3, coug_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  coug.wtd.hunt_fl <- fitList(coug.wtd.hunt_null0, coug.wtd.hunt_null1, coug.wtd.hunt_null2, coug.wtd.hunt_habpub0, coug.wtd.hunt_habpub1, coug.wtd.hunt_huntpub1, coug.wtd.hunt_huntpub2) 
  #' Model selection
  modSel(coug.elk.hunt_fl)
  ...
  (coug.moose.hunt_habpub2 <- occuMulti(detFormulas_pub, occFormulas_habpubish2, coug_moose_hunter_hunting_UMF, silent = TRUE)) # FAIL
  (coug.moose.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpubish3, coug_moose_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  coug.moose.hunt_fl <- fitList(coug.moose.hunt_null0, coug.moose.hunt_null1, coug.moose.hunt_null2, coug.moose.hunt_habpub0, coug.moose.hunt_habpub1, coug.moose.hunt_huntpub1, coug.moose.hunt_huntpub2) 
  #' Model selection
  ...
  (wolf.md.hunt_habpub2 <- occuMulti(detFormulas_pubish, occFormulas_habpubish2, wolf_md_hunter_hunting_UMF, silent = TRUE)) 
  (wolf.md.hunt_habpub3 <- occuMulti(detFormulas_pubish, occFormulas_habpubish3, wolf_md_hunter_hunting_UMF, silent = TRUE))
  ...
  #' List of fitted models
  wolf.md.hunt_fl <- fitList(wolf.md.hunt_null0, wolf.md.hunt_null1, wolf.md.hunt_null2, wolf.md.hunt_habpub0, wolf.md.hunt_habpub1, wolf.md.hunt_habpub2, wolf.md.hunt_habpub3) 
  #' Model selection
  ...
  (wolf.elk.hunt_habpub2 <- occuMulti(detFormulas_pubish, occFormulas_habpubish2, wolf_elk_hunter_hunting_UMF, silent = TRUE)) 
  (wolf.elk.hunt_habpub3 <- occuMulti(detFormulas_pubish, occFormulas_habpubish3, wolf_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  wolf.elk.hunt_fl <- fitList(wolf.elk.hunt_null0, wolf.elk.hunt_null1, wolf.elk.hunt_habpub0, wolf.elk.hunt_habpub2) 
  #' Model selection
  ...
  (wolf.wtd.hunt_habpub3 <- occuMulti(detFormulas_pubish, occFormulas_habpubish3, wolf_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  wolf.wtd.hunt_fl <- fitList(wolf.wtd.hunt_null0, wolf.wtd.hunt_null1, wolf.wtd.hunt_null2, wolf.wtd.hunt_habpub0, wolf.wtd.hunt_habpub1, wolf.wtd.hunt_huntpub1) 
  #' Model selection
  ...
  (wolf.moose.hunt_habpub3 <- occuMulti(detFormulas_pubish, occFormulas_habpubish3, wolf_moose_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  wolf.moose.hunt_fl <- fitList(wolf.moose.hunt_null0, wolf.moose.hunt_null1, wolf.moose.hunt_null2, wolf.moose.hunt_habpub0, wolf.moose.hunt_habpub1) 
  #' Model selection
  ...
  (bear.md.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bear_md_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  bear.md.hunt_fl <- fitList(bear.md.hunt_null0, bear.md.hunt_null1, bear.md.hunt_null2, bear.md.hunt_habpub0, bear.md.hunt_habpub1, bear.md.hunt_habpub2, bear.md.hunt_huntpub1, bear.md.hunt_huntpub2) 
  #' Model selection
  ...
  (bear.elk.hunt_habpub2 <- occuMulti(detFormulas_pub, occFormulas_habpub2, bear_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL Model did not converge. Try providing starting values or increasing maxit control argment.
  (bear.elk.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bear_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL
  (bear.elk.hunt_huntpub1 <- occuMulti(detFormulas_pub, occFormulas_huntpub1, bear_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL Error in optim(starts, nll, method = method, hessian = se, ...) : non-finite finite-difference value [20]
  (bear.elk.hunt_huntpub2 <- occuMulti(detFormulas_pub, occFormulas_huntpub2, bear_elk_hunter_hunting_UMF, silent = TRUE)) # FAIL
  #' List of fitted models
  bear.elk.hunt_fl <- fitList(bear.elk.hunt_null0, bear.elk.hunt_null1, bear.elk.hunt_habpub0, bear.elk.hunt_habpub1) 
  #' Model selection
  ...
  (bear.wtd.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bear_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL: Model did not converge. Try providing starting values or increasing maxit control argment.
  ...
  #' List of fitted models
  bear.wtd.hunt_fl <- fitList(bear.wtd.hunt_null0, bear.wtd.hunt_null1, bear.wtd.hunt_null2, bear.wtd.hunt_habpub0, bear.wtd.hunt_habpub1, bear.wtd.hunt_huntpub1, bear.wtd.hunt_huntpub2) 
  #' Model selection
  ...
  (bear.moose.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bear_moose_hunter_hunting_UMF, silent = TRUE)) # FAIL: Model did not converge. Try providing starting values or increasing maxit control argment.
  ...
  (coy.md.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, coy_md_hunter_hunting_UMF, silent = TRUE)) # FAIL: Model did not converge. Try providing starting values or increasing maxit control argment.
  ...
  #' List of fitted models
  coy.md.hunt_fl <- fitList(coy.md.hunt_null0, coy.md.hunt_null1, coy.md.hunt_null2, coy.md.hunt_habpub0, coy.md.hunt_habpub1, coy.md.hunt_habpub2, coy.md.hunt_huntpub1, coy.md.hunt_huntpub2) 
  #' Model selection
  ...
  (coy.wtd.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, coy_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  coy.wtd.hunt_fl <- fitList(coy.wtd.hunt_null0, coy.wtd.hunt_null1, coy.wtd.hunt_null2, coy.wtd.hunt_habpub0, coy.wtd.hunt_habpub1, coy.wtd.hunt_habpub2, coy.wtd.hunt_huntpub1, coy.wtd.hunt_huntpub2) 
  #' Model selection
  ...
  (bob.md.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bob_md_hunter_hunting_UMF, silent = TRUE)) 
  ...
  #' List of fitted models
  bob.md.hunt_fl <- fitList(bob.md.hunt_null0, bob.md.hunt_null1, bob.md.hunt_null2, bob.md.hunt_habpub0, bob.md.hunt_habpub1, bob.md.hunt_habpub2, bob.md.hunt_habpub3, bob.md.hunt_huntpub1, bob.md.hunt_huntpub2) 
  #' Model selection
  modSel(bob.md.hunt_fl)
  summary(coy.md.hunt_huntpub1)
  summary(coy.md.hunt_habpub0)
  summary(coy.md.hunt_habpub1)
  summary(coy.md.hunt_huntpub2)
  ...
  (bob.wtd.hunt_habpub3 <- occuMulti(detFormulas_pub, occFormulas_habpub3, bob_wtd_hunter_hunting_UMF, silent = TRUE)) # FAIL
  ...
  #' List of fitted models
  bob.wtd.hunt_fl <- fitList(bob.wtd.hunt_null0, bob.wtd.hunt_null1, bob.wtd.hunt_null2, bob.wtd.hunt_habpub0, bob.wtd.hunt_habpub1, bob.wtd.hunt_habpub2, bob.wtd.hunt_huntpub1, bob.wtd.hunt_huntpub2) 
  #' Model selection
  ...
  #'  Hunting season models
  mocc_coug.md.hunt <- occ_out(coug.md.hunt_huntpub1, "Cougar", "Mule Deer", "Hunter", "Hunting")
  ...
  results_hunt_wide <- results_hunt %>%
    ...
    relocate("[Species 1:Species 3] (Intercept)", .after = "[Species 3] Study_AreaOK") %>%
    relocate("[Species 1:Species 3] HuntingActivity", .after = "[Species 1:Species 3] (Intercept)") %>%
    relocate("[Species 1:Species 3] Public1", .after = "[Species 1:Species 3] HuntingActivity") %>%
    relocate("[Species 2:Species 3] (Intercept)", .after = "[Species 3] Study_AreaOK") %>%
    relocate("[Species 2:Species 3] HuntingActivity", .after = "[Species 2:Species 3] (Intercept)") %>%
    relocate("[Species 2:Species 3] Public1", .after = "[Species 2:Species 3] HuntingActivity") %>%
    relocate("[Species 1] I(Elev^2)", .after = "[Species 1] Elev") %>%
    relocate("[Species 2] I(Elev^2)", .after = "[Species 2] Elev") %>%
    ...
    separate("[Species 1:Species 3] HuntingActivity", c("[Species 1:Species 3] HuntingActivity (SE)", "[Species 1:Species 3] HuntingActivity Pval"), sep = "_") %>%
    separate("[Species 1:Species 3] Public1", c("[Species 1:Species 3] Public1 (SE)", "[Species 1:Species 3] Public1 Pval"), sep = "_") %>%
    separate("[Species 2:Species 3] (Intercept)", c("[Species 2:Species 3] Intercept (SE)", "[Species 2:Species 3] Intercept Pval"), sep = "_") %>%
    separate("[Species 2:Species 3] HuntingActivity", c("[Species 2:Species 3] HuntingActivity (SE)", "[Species 2:Species 3] HuntingActivity Pval"), sep = "_") %>%
    separate("[Species 2:Species 3] Public1", c("[Species 2:Species 3] Public1 (SE)", "[Species 2:Species 3] Public1 Pval"), sep = "_") %>%
    arrange(match(Species1, c("Black Bear", "Bobcat", "Cougar", "Coyote", "Wolf"))) 
