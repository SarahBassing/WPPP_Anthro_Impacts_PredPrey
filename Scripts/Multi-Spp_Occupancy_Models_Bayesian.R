  ...
  #' cat(file = './Outputs/JAGS_models/multi-spp_OccMod.txt', "
  #' model{
  #' 
  #'   ##### Define Priors  ####
  #'   #'  =================
  ...
  #'     psiSpp23[i] <- psiSpp2[i] + psiSpp3[i] + betaSpp23[1]*psi_inxs_cov[i,1] # no beta2 on this interaction
  #'     psiSpp13[i] <- psiSpp1[i] + psiSpp3[i] + betaSpp13[1]*psi_inxs_cov[i,1] # no beta2 on this interaction
  #' 
  #'     #'  ...for state Spp123
  ...
  #'       rhoSpp3[i, j] <- alphaSpp3[1]*rho_cov[i,j,1] + alphaSpp3[2]*rho_cov[i,j,2] # no anthro activity on this spp
  #' 
  ...
  # 4. MUST get parallel working!!! currently taking 10 hours to run this model
